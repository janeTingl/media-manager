#!/usr/bin/env python3
"""
Unified build script for 影藏·媒体管理器 cross-platform executables.

This script provides a single interface to build 影藏·媒体管理器 for multiple platforms:
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        description="Build 影藏·媒体管理器 for multiple platforms",
...
def main():
    ...
    print("影藏·媒体管理器 Cross-Platform Build Tool")
    print("=" * 60)
    ...
    if failed_builds:
        ...
        print("  - Executables: dist/")
        print("  - Distribution packages: package/")
