...
from PySide6.QtGui import QPixmap, QDesktopServices, QPalette
...
class DetailPanel(QFrame):
    ...
    def _setup_ui(self) -> None:
        ...
        self._title_label = QLabel("Details")
        ...
        self._collapse_button.setStyleSheet("QToolButton { border: none; padding: 2px; }")
    ...
    def _setup_poster_section(self) -> None:
        ...
        self._poster_container = QGroupBox("Poster")
    ...
    def _setup_metadata_section(self) -> None:
        ...
        self._metadata_container = QGroupBox("Information")
    ...
    def _setup_cast_section(self) -> None:
        ...
        self._cast_container = QGroupBox("Cast")
    ...
    def _setup_actions_section(self) -> None:
        ...
        self._actions_container = QGroupBox("Actions")
        ...
        self._edit_button = QPushButton("Edit Metadata")
        self._edit_button.clicked.connect(self._on_edit_clicked)
        self._actions_layout.addWidget(self._edit_button)
        
        self._download_poster_button = QPushButton("Download Poster")
    ...
    def _setup_files_section(self) -> None:
        ...
        self._files_container = QGroupBox("Files")
        self._files_layout = QVBoxLayout(self._files_container)
        
        self._files_label = QLabel("No file information available")
        self._files_label.setWordWrap(True)
        self._files_label.setTextInteractionFlags(Qt.TextInteractionFlag.TextSelectableByMouse)
        
        self._files_layout.addWidget(self._files_label)
        
        self._content_layout.addWidget(self._files_container)

    def set_media_item(self, item: Optional[MediaItem]) -> None:
    ...
    def _update_metadata(self, item: MediaItem) -> None:
        ...
        # Year
        self._metadata_labels["year"].setText(str(item.year) if item.year else "Unknown")
        
        # Type
        self._metadata_labels["type"].setText(item.media_type.capitalize() if item.media_type else "Unknown")
        ...
        # Added date
        if item.created_at:
            self._metadata_labels["added"].setText(item.created_at.strftime("%Y-%m-%d %H:%M"))
        else:
